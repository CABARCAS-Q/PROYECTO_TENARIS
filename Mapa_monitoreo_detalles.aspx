<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mapa_monitoreo_detalles.aspx.cs" Inherits="Helpdesk_Auto.Helpdesk.Mapa_monitoreo_detalles" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Monitor Detalles Server</title>
    ...
    <script src="../Js_codigos/Mapa_monitoreo_detalles.js"></script>
  ...
  opacity: 0.5;
    ...
    <div class="content">
        <div class="header">
                                ...
                                <h1 class="page-title">Mapa Monitor Detalles</h1>
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-2">
                                 <label  style="color:black; font-size: 14px">Buscar Por :</label>
                                 </div>
                            </div>
                            <div class="form-group">
                                 <div class="col-sm-2">
                                 ...
                                 <div class="col-sm-2">
                                 <label  style="color:black; font-size: 14px">Importante/Reporte</label>
                                 </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="listamot"  class="form-controll form-control" style="text-align:left" ></select>
                                 </div>
                                            ...
                                            <table id="table_sol" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr data-id="id">
                                                        ...
                                                        <th style="width: 5% !important;">Codigo</th>
                                                        <th style="width: 12% !important;">Linea</th>
                                                        <th style="width: 10% !important;">Tipo</th>
                                                        <th style="width: 48% !important;">Nombre Servicio</th>
                                                        <th style="width: 5% !important;">Consumo (MB)</th>
                                                        <th style="width: 10% !important;">Fecha</th>
                                                        <th style="width: 5% !important;">Tipo</th>
