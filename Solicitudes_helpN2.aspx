<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Solicitudes_helpN2.aspx.cs" EnableEventValidation="false"  Inherits="Helpdesk_Auto.Helpdesk.Solicitudes_helpN2" 
  Culture="es-MX"  %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Solicitudes Help Desk N2</title>
    ...
    <script src="../Js_codigos/Solicitudes_helpN2.js"></script>
   ...
   <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    ...
    <div class="content">
        <div class="header">
                                ...
                                <h1 class="page-title">Solicitudes Help Desk N2</h1>
                        ...
                        <div class="form">
                            <div class="form-horizontal">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Fecha Inicio/Fin</label></label>
                                    <div class="col-sm-6"> 
                                      <input  runat="server" id="fechas" type="text" name="fechas" readonly="true"  class="form-controll form-control" style="text-align:left" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Maquina Afectada</label></label>
                                    <div class="col-sm-6"> 
                                      <select id="listamaq" class="form-control" ></select>
                                    </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Problema / Reporte / Vista</label></label>
                                    <div class="col-sm-6"> 
                                      <select id="listamov" class="form-control" ></select>
                                    </div>
                                    </div>
                                   <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Grupo Asignado</label></label>
                                    <div class="col-sm-6"> 
                                      <select id="idlistagp" class="form-control" ></select>
                                    </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Estado Solicitud</label></label>
                                    <div class="col-sm-6"> 
                                      <select id="idlistamov" class="form-control"  ></select>
                                    </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Descripcion / Solicitud</label></label>
                                        <div class="col-sm-6"> 
                                        <textarea id="Descripcion" rows="10" maxlength="20000" cols="83"></textarea>
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px"></label></label>
                                        <div class="col-sm-6"> 
                                        En este campo favor describir detalladamente todo lo relacionado con el problema que se le este presentado,para realizar de forma eficaz la solucion o analisis.
                                        </div>
                                    </div>
                                ...
                                <asp:UpdatePanel ID="updatePanel" runat="server" >
                                      <ContentTemplate> 
                                          <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Adjuntos Solicitud</label></label>
                                        <div class="col-sm-6"> 
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-6"> 
                                        <textarea id="iddescripcionsolucionp" rows="10" maxlength="20000" cols="83"></textarea>
                                        </div>
                                    </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-6"> 
                                        <textarea id="iddescripcionsolucionp2" rows="10" maxlength="20000" cols="83"></textarea>
                                        </div>
                                    </div>
