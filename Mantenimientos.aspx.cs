...
namespace Helpdesk_Auto.Helpdesk
{
    public partial class Mantenimientos : System.Web.UI.Page
    {
        ...
        private static MyLogClass Log = new MyLogClass("Mantenimientos.aspx");
                ...
                try
                {
                    ...
                    if (re.Count > 0)
                    {
                        ...
                        foreach (Object obj in re)
                        {
                            ...
                            if (valor[4] == "Mantenimientos.aspx")
                            {
                                validaventana = 1;
                            }
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string detalle_linea(string Linea)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Monitor].[Lista_detalle_mantenimientos]", parametros);
            }
            catch (Exception er)
            {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string Lista_tipos()
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos("[Monitor].[Lista_tipos_mantenimientos]");
            }
            catch (Exception er)
            {
        ...
        protected void UploadComplete(object sender, AjaxControlToolkit.AjaxFileUploadEventArgs e)
        {
            ...
            try
            {
                ...
                if (Session["Imagenes_mantenimiento"].ToString().Length > 1)
                {
                    Session["Imagenes_mantenimiento"] = Session["Imagenes_mantenimiento"] + "|" + fileName.ToString();
                }
                else
                {
                    Session["Imagenes_mantenimiento"] = fileName.ToString();
                }
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string crear_solicitud(string linea, string tipo, string observaciones)
        {
            ...
            try
            {
                ...
                string imagenes = HttpContext.Current.Session["Imagenes_mantenimiento"].ToString();
                ...
                {
                    valor = "-4";
                    error_mensaje = "no hay imagenes adjuntas revise y cargue las imagenes";
                    return JsonConvert.SerializeObject(new { Error = error, Mensaje_error = error_mensaje, Resul = valor });
                }
                ...
                Consultas objetoconexiones = new Consultas();
                ArrayList re = objetoconexiones.metodolista_datos1("[Monitor].[Generar_nuevo_mantenimiento]", parametros);
                if (re.Count > 0)
                {
                    ...
                    foreach (Object obj in re)
                    {
                        ...
                        {
                            valor = "1";
                            HttpContext.Current.Session["Imagenes_mantenimiento"] = "";
        ...
        public static string Detalle_imagenes(string ticket)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Monitor].[Detalle_imagenes]", parametros);
            }
            catch (Exception er)
            {
        ...
        public static string Detalle_imagenes2(string id)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Monitor].[Detalle_imagenes2]", parametros);
            }
            catch (Exception er)
            {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string Detalle_hist(string idticket,string linea)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Monitor].[Detalle_history_mantenimientos]", parametros);
            }
            catch (Exception er)
            {
