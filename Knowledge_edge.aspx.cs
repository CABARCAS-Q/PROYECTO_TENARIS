...
{
    public partial class Knowledge_edge : System.Web.UI.Page
    {
        Consultas objetoconexiones = new Consultas();
        private static MyLogClass Log = new MyLogClass("Knowledge_edge.aspx");
            ...
            try
            {
                ...
                if (re.Count > 0)
                {
                    ...
                    foreach (Object obj in re)
                    {
                        ...
                        if (valor[4] == "Knowledge_edge.aspx")
                        {
                            validaventana = 1;
                        }
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string lista_solicitudes( string fecha1, string fecha2, string linea, string maquina, string detalle)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Helpdesk].[Lista_solicitudes_knowledge_edge]", parametros);
            }
            catch (Exception er)
            {
