<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Monitor_auto.aspx.cs" Inherits="Helpdesk_Auto.Helpdesk.Monitor_auto" %>
<!DOCTYPE html>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Monitor Equipos Auto</title>
    ...
    <script src="../Js_codigos/monitor_auto.js"></script>
  ...
  opacity: 0.5;
    ...
    <div class="content">
        <div class="header">
                                ...
                                <h1 class="page-title">Monitor Auto</h1>
                                            ...
                                            <table id="table_sol" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr data-id="id">
                                                        ...
                                                        <th style="width: 12% !important;">Linea</th>
                                                        <th style="width: 13% !important;">Maquina</th>
                                                        <th style="width: 15% !important;">Nombre</th>
                                                        <th style="width: 5% !important;">RAM Li(MB)</th>
                                                        <th style="width: 5% !important;">RAM To(MB)</th>
                                                        <th style="width: 5% !important;">RAM Li(%)</th>
                                                        <th style="width: 5% !important;">RAM To(%)</th>
                                                        <th style="width: 5% !important;">HHD</th>
                                                        <th style="width: 10% !important;">Actividad</th>
                                                        <th style="width: 10% !important;">Fecha</th>
                                                        <th style="width: 5% !important;">IP</th>
