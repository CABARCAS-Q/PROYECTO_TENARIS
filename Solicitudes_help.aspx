<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Solicitudes_help.aspx.cs"  EnableEventValidation="false"  Inherits="Helpdesk_Auto.Helpdesk.Solicitudes_help" Culture="es-MX" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Solicitudes Help Desk</title>
   ...
   <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    ...
    <div class="content">
        <div class="header">
                                ...
                                <h1 class="page-title">Solicitudes Help Desk</h1>
                        ...
                        <div class="form">
                            <div class="form-horizontal">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Descripcion</label></label>
                                        <div class="col-sm-6"> 
