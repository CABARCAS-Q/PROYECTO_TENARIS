<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Solucion_especializada.aspx.cs" Inherits="Helpdesk_Auto.Helpdesk.Solucion_especializada" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Solucion Especializada</title>
    ...
    <script src="../Js_codigos/Solucion_especializada.js"></script>
  ...
  opacity: 0.5;
    ...
    <div class="content">
        <div class="header">
                                ...
                                <h1 class="page-title">Solucion Especializada</h1>
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="form">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                 <div class="col-sm-2">
                                 <label  style="color:black; font-size: 14px">Grupo</label>
                                 </div>
                                 <div class="col-sm-2">
                                 ...
                                 <div class="col-sm-2">
                                 <label  style="color:black; font-size: 14px">Filtro</label>
                                 </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">      
                                       
                                <select id="idlistagp0"  class="form-controll form-control" style="text-align:left" ></select>
                                    </div>
                                <div class="col-sm-2"> 
                                ...
                                <select id="idlistatipo"  class="form-controll form-control" style="text-align:left" ></select>
                                 </div>
                            </div>
                            <div class="form-group">
                                 <div class="col-sm-2">
                                 <label  style="color:black; font-size: 14px">Buscar Por : Codigo</label>
                                 </div>
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                 <label  style="color:black; font-size: 14px">Estados</label>
                                 </div>
                                <div class="col-sm-2">
                                 <label  style="color:black; font-size: 14px">Usuario Help</label>
                                 </div>
                            </div>
                            
                            <div class="form-group">
                                <div class="col-sm-2">      
                                        <input type ="text" id="Codigo" autofocus="autofocus" maxlength="10"   class="form-controll form-control"  placeholder="Codigo" />  
                                ...
                                <div class="col-sm-2"> 
                                      <select id="listamot" class="form-control" ></select>
                                </div>
                                <div class="col-sm-2">      
                                            ...
                                            <table id="table_sol" class="table table-bordered dt-responsive nowrap" cellspacing="0"  width="100%">
                                                <thead>
                                                    <tr data-id="id">
                                                        ...
                                                        <th style="width: 10%;">Usuario Sol</th>
                                                        <th style="width: 10%;">Problema</th>
                                                        <th style="width: 5%;">Prioridad</th>
                                                        <th style="width: 5%;">Estado</th>
                                                        <th style="width: 10%">Inicio Sol</th>
                                                        <th style="width: 10%;">Usuario Help</th>
                                                        <th style="width: 5%;"></th>
                                                    </tr>
                                                </thead>
                                                <tfoot>
                  ...
                  <p>
                   ...
                   <p>
                         <label id="labelSolucionespecializada" style="font-weight: bold;" >Requiere Solucion especializada</label>
                          <label id="Solucionespecializada" >-</label>
                   </p> 
                   <p>
