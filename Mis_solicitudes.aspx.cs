...
{
    public partial class Mis_solicitudes : System.Web.UI.Page
    {
        Consultas objetoconexiones = new Consultas();
        private static MyLogClass Log = new MyLogClass("Mis_solicitudes.aspx");
            ...
            try
            {
                ...
                if (re.Count > 0)
                {
                    ...
                    foreach (Object obj in re)
                    {
                        ...
                        if (valor[4] == "Mis_solicitudes.aspx")
                        {
                            validaventana = 1;
                        }
        ...
        public static string lista_solicitudes(string codigo, string fecha1, string fecha2, string linea, string maquina, string estado, string usuarioh)
        {
