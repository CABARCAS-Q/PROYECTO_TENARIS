<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Perfiles_config.aspx.cs" Inherits="Helpdesk_Auto.Helpdesk.Perfiles_config" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Configuraciones de perfiles</title>
    ...
    <script type="text/javascript" src="../lib/DataTables/datatables.min.js"></script>
     ...
     <script src="../Js_codigos/Perfiles_config.js"></script>
</head>
<body class=" theme-blue">
    ...
    <div class="content">
        <div class="header">
                                ...
                                <h1 class="page-title">Configuraciones de Perfiles</h1>
             ...
             <div class="row">
                <div class="col-sm-12 col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading no-collapse">Perfiles del sistemas<span class="label label-warning"></span></div>
                        <div class="form">
                           <div class="form-horizontal">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                            <label for="nombrep" class="col-sm-2 control-label"><label  style="color:black; font-size: 14px">Agregar Nuevo Perfil</label></label>
                            <div class="col-sm-6">      
                                <input type ="text" id="nombrep" autofocus="autofocus" maxlength="20"  class="form-controll form-control"  placeholder="Nombre Perfil" />  
                            ...
                            <div class="col-sm-1">
                                   <button id="guardar" runat="server"  style="height:35px; width:35px;text-align:left;color:black" class="btn btn-default" type="button"
                                    onclick="crear_perfil_accion();"  data-toggle="tooltip" title="Guardar" ><i class="fa fa-floppy-o"></i></button>        
                            </div>
                          </div>

                           </div>
                         </div>
                        <div class="panel-heading no-collapse">Perfiles permisos<span class="label label-warning"></span></div>
                        <div class="form">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     <label for="listap" class="col-sm-2 control-label"><label  
                                         style="color:black; font-size: 14px">Gestionar Perfil</label></label>
                                     ...
                                     <button id="buscar" runat="server"  style="height:35px; width:35px;text-align:left;color:black" class="btn btn-default" type="button"
                                        onclick="lista_permisos();" data-toggle="tooltip" title="Buscar" ><i class="fa fa-search"></i></button>        
                                     </div>

                                    </div>
                                    <div class="row">
                                    <div class="col-sm-12 col-md-12 col-xs-12">
                                            <table id="table_perfiles" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr data-id="id">
