...
{
    public partial class Perfiles_config : System.Web.UI.Page
    {

        Consultas objetoconexiones = new Consultas();
        private static MyLogClass Log = new MyLogClass("Perfiles_config.aspx");
            ...
            try
            {
                ...
                if (re.Count > 0)
                {
                    ...
                    foreach (Object obj in re)
                    {
                        ...
                        if (valor[4] == "Perfiles_config.aspx")
                        {
                            validaventana = 1;
                        }
        ...
        public static string crear_perfil(string perfil)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                ArrayList re = objetoconexiones.metodolista_datos1("[Sis_config].[Insertar_perfil]", parametros);
                if (re.Count > 0)
                {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string lista_perfiles()
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos("[Sis_config].[Lista_perfiles]");
            }
            catch (Exception er)
            {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string lista_menus(string nperfil)
        {
            ...
            try
            {
                ...
                Dictionary<string, Object> parametros = new Dictionary<string, object>();
                parametros.Add("nombre_perfil", nperfil);

                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Sis_config].[Lista_menus_perfil]",parametros);
            }
            catch (Exception er)
            {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string delete_menu(string perfil,string menu)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                ArrayList re = objetoconexiones.metodolista_datos1("[Sis_config].[Eliminar_menu_pefiles]", parametros);
                if (re.Count > 0)
                {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string add_menu(string perfil, string menu)
        {
            ...
            try
            {
                ...
                Debug.WriteLine("perfil:"+ perfil);
                Debug.WriteLine("menu:"+ menu);

                Consultas objetoconexiones = new Consultas();
                ArrayList re = objetoconexiones.metodolista_datos1("[Sis_config].[Insertar_perfil_usuario]", parametros);
                if (re.Count > 0)
                {
