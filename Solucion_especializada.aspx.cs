...
{
    public partial class Solucion_especializada : System.Web.UI.Page
    {
        Consultas objetoconexiones = new Consultas();
        private static MyLogClass Log = new MyLogClass("Solucion_especializada.aspx");
            ...
            try
            {
                ...
                if (re.Count > 0)
                {
                    ...
                    foreach (Object obj in re)
                    {
                        ...
                        if (valor[4] == "Solucion_especializada.aspx")
                        {
                            validaventana = 1;
                        }
            ...
            else
            {
                ...
                try
                {
                        ...
                        else
                        {
                            ...
                            bfechaini1.Value = Request.QueryString["F1"].ToString();
                            bfechafin2.Value = Request.QueryString["F2"].ToString();
                            bfiltro.Value = Request.QueryString["Fil"].ToString();
                            blinea.Value = Request.QueryString["Li"].ToString();
                            busuario.Value = Request.QueryString["Us"].ToString();
                            btiposol.Value = Request.QueryString["Ti"].ToString();
        ...
        public static string lista_solicitudes(string codigo, string fecha1, string fecha2, string linea, string maquina, string estado, string usuarioh, string filtro)
        {
            ...
            try
            {
                ...
                parametros.Add("Tipofiltro", filtro);
                ...
                {
                    if (usuarioh != "No Definido")
                    {
                        parametros.Add("usuario_helpk", usuarioh);
                    }
                    else
                    {
                        if (estado == "0")
                        {
                            parametros.Add("estado", "SOLN");
                        }
                    }
                }

                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Helpdesk].[Lista_solicitudes_solucion]", parametros);
            }
            catch (Exception er)
            {
