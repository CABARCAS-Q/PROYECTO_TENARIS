...
{
    public partial class Monitor_auto : System.Web.UI.Page
    {
        Consultas objetoconexiones = new Consultas();
        private static MyLogClass Log = new MyLogClass("Monitor_auto.aspx");
        ...
        public static string lista_reporte(string fecha1, string fecha2, string linea, string maquina, string estado)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Monitor].[Lista_reportes_maquinas]", parametros);
            }
            catch (Exception er)
            {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string Detalle_hhd(string maquina)
        {
            ...
            {
                Dictionary<string, Object> parametros = new Dictionary<string, object>();
                parametros.Add("Id_machine", maquina);


                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Monitor].[Detalle_hhd]", parametros);
            }
            catch (Exception er)
            {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string Chart_ram(string maquina)
        {
            ...
            try
            {
                ...
                Consultas objetoconexiones = new Consultas();
                dt = objetoconexiones.metodolista_datos_d1("[Monitor].[Detalle_ram_chart]", parametros);
            }
            catch (Exception er)
            {
