<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Knowledge_edge.aspx.cs" Inherits="Helpdesk_Auto.Helpdesk.Knowledge_edge" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="../Js_codigos/Knowledge_edge.js"></script>
  ...
  opacity: 0.5;
                       ...
                       <div class="form">
                        <div class="form-horizontal">
                              <div class="  form-group ">
                               <div class="col-sm-8">
                               <label  style="color:black; font-size: 14px">Filtrar por fechas</label>
                               </div>
                                 <div class="col-sm-2">
                                  <input id="filtro0" type="checkbox" />
                                  </div> 
                               </div>
                               <div class="  form-group ">
                               <div class="col-sm-3">
                               <label  style="color:black; font-size: 14px">Inicio</label>
                               </div>
                               <div class="col-sm-8"> 
                              ...
                              <div class="  form-group ">
                               <div class="col-sm-3">
                               <label  style="color:black; font-size: 14px">Fin</label>
                               </div>
                               <div class="col-sm-8"> 
                              ...
                              <div class="form-group">
                                 <div class="col-sm-10">
                                 <label  style="color:black; font-size: 14px">Filtro Avanzado de busqueda</label>
                                 </div>
                              </div>
                              <div class="form-group">
                                  <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                  <div class="col-sm-10">
                                 <label  style="color:black; font-size: 14px">Por detalle</label>
                                 </div>
                                     <div class="col-sm-11"> 
                                                <textarea id="detalle" rows="5" maxlength="5000" cols="41" class="form-controll form-control" ></textarea>     
                                      </div>
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-sm-2">
                                       <button id="buscar" runat="server"  style="height:35px; width:35px;text-align:left;color:black" class="btn btn-default" type="button" onclick="lista_solicitudes();"
                                         data-toggle="tooltip" title="Buscar" ><i class="fa fa-search"></i></button>        
                                   </div>
                               </div>
                        </div>
                        </div>
    ...
    <div class="content">
        <div class="header">
                                ...
                                <h1 class="page-title">Knowledge Base Automatizacion N2</h1>
                                            ...
                                            <table id="table_sol" class="table table-bordered dt-responsive nowrap" cellspacing="0"  width="100%">
                                                <thead>
                                                    <tr data-id="id">
                                                        ...
                                                        <th style="width: 10%;">Maquina</th>
                                                        <th style="width: 25%;">Problema</th>
                                                        <th style="width: 25%;">Solucion</th>
                                                        <th style="width: 5%;"></th>
                                                    </tr>
                                                </thead>
                                                <tfoot>
