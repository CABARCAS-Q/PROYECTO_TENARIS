...
namespace Helpdesk_Auto.Helpdesk
{
    public partial class Menu : System.Web.UI.Page
    {
        ...
        private static MyLogClass Log = new MyLogClass("Menu.aspx");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["Imagenes"] = "";
            Session["ImagenesN2"] = "";
            Session["Imagenes_mantenimiento"] = "";
            Session["Archivos"] = "";
            Session["DBN2"] = "";
            ...
            try
            {
                ...
                {
                    string mensaje = "Bienvenido " + Session["usuarionombre"].ToString();

                    
                    sb.Append(@"<script type='text/javascript'>");
                    sb.Append(@"$(document).ready(function () {  toastr.success('" + mensaje + "','Info', {timeOut: 5000});}); ");
                    sb.Append(@"</script>");
