 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reporte_inventario_nuevo.aspx.cs" Inherits="Helpdesk_Auto.Helpdesk.Reporte_inventario_nuevo" %>
...
<meta http-equiv="X-UA-Compatible" content="IE=10,IE=11"/>
    ...
    <script src="../Js_codigos/Reporte_inventario_nuevo.js"></script>

    
    <script src="../Js_codigos/exportacion.js"></script>
  ...
  opacity: 0.5;
    ...
    <div class="content">
        <div class="header">
                                ...
                                <h1 class="page-title">Reporte Inventarios</h1>
                    ...
                    <div class="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                 <label  style="color:black; font-size: 14px">Maquinas</label>
                                 </div>
                               <div class="col-sm-2">
                                    <label  style="color:black; font-size: 14px" for="filtro_estado">ver Historico</label>
                                   </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2"> 
                                      <select id="listal" class="form-control" onchange="lista_maquinas();"></select>
                                            ...
                                            <div class="col-sm-2"> 
                                              <select id="filtromaquina" class="form-control" > </select>
                                  ...
                                  <button id="Button2" runat="server"  style="height:35px; width:35px;text-align:left;color:black" class="btn btn-default" type="button"
                                        onclick="datoslineas();" data-toggle="tooltip" title="buscar" ><i class="fa fa-search"></i></button> 

                                <button id="Button3" runat="server"  style="height:35px; width:35px;text-align:left;color:black"  type="button"
                                        onclick="eliminarRegistrosTabla();" data-toggle="tooltip" title="limpiar"> <i class="glyphicon glyphicon-trash"></i></button> 
      

                               
 <button class="btn btn-primary" onclick="exportarTablasExcel()">Exportar a Excel</button>
        ...
        <div style="overflow-x: auto;">
            <div id="table-container">
                <table id="table_sol" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%" >
                   <caption>INFORME DE ACCESORIOS</caption>
                    <thead>
                        <tr data-id="id">
                          
                            <th style="width:5% !important;">maquina</th>
                           
                            <th style="width:8% !important;">Fecha</th>
                            <th style="width:5% !important;">PC</th>
                            <th style="width:8% !important;">pantalla</th>
                            <th style="width:8% !important;">mouse</th>
                            <th style="width:8% !important;">teclado</th>
                            <th style="width:8% !important;">cableEpc</th>
                            <th style="width:8% !important;">cableEpa</th>
                            <th style="width:8% !important;">cablered</th>
                            <th style="width:8% !important;">puerto red</th>
                            <th style="width:8% !important;">vga</th>
                        </tr>
                    </thead>
                    <tfoot></tfoot>
                </table>
...
<div style="margin-top: 50px;"></div> <!-- Espacio en blanco entre las tablas -->
<div class="row">
    <div class="col-sm-12 col-md-12 col-xs-12">
        <div style="overflow-x: auto;">
            <div id="table-observacion">
                <table id="table_luna" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%" >
                   <caption>VER OBSERVACIONES</caption>
                    <thead>
                        <tr data-id="id">
                          <th style="width:8% !important;">Linea</th>
                            <th style="width:5% !important;">maquina</th>
                       
                            <th style="width:8% !important;">Fecha</th>
                               <th style="width:8% !important;">Observaciones</th>
...
<div class="row">
    <div class="col-sm-12 col-md-12 col-xs-12" style="display: none;">
        <div style="overflow-x: auto;">
            <div id="table-tilin">
                <table id="table_prueba" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                   <caption>Prueba</caption>
                    <thead>
                        <tr data-id="id">
                            <th style="width:10% !important;">Nombre</th>
                            <th style="width:5% !important;">maquina</th>
                            <th style="width:8% !important;">Fecha</th>
                            <th style="width:8% !important;">Observaciones</th>
                        </tr>
...
<
    ...
    <style>
           ...
           .table_prueba {
      display: none; /* Alternativamente, puedes usar visibility: hidden; */
    }
